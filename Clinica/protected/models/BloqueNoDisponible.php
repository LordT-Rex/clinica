...
class BloqueNoDisponible extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('fecha, id_bloque, bloqueInicio, bloqueFin', 'required'),
        ...
        /*public function searchByBloque($bloque)
	{
        ...
        public function getMenuHorasFin() {
            
            return CHtml::listData(Bloque::model()->findAllByAttributes(array('id_dia'=>1)), "fin", "fin");
